...
// This is different from API credentials - it's a public client key for browser SDK
// Configure this if you want to show a Coinbase Onramp paywall for browser users
// https://docs.cdp.coinbase.com/onramp/docs/getting-started
